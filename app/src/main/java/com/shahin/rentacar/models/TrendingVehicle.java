...
public class TrendingVehicle {
    ...
    public TrendingVehicle(String vehicleName, String vehicleDescription, String vehicleRating, String seat, String gate, String bag, int vehicleImage, String pricePerDay) {
